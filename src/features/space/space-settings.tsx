          ...
          <div className="space-y-2 pt-2 border-t border-border">
            ...
            <div className="grid grid-cols-5 gap-2 sm:grid-cols-6 sm:gap-3">
              {!originalAvatar && (
                <button
                  onClick={() => {
                    authClient.signIn.social({ provider: "google", callbackURL: "/settings" });
                  }}
                  className="relative flex items-center justify-center h-10 w-10 rounded-full border-2 border-transparent transition-all hover:scale-105 active:scale-95 bg-muted hover:border-border touch-manipulation sm:h-12 sm:w-12"
                  title="Lấy lại ảnh từ Google"
                >
