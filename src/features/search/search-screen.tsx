      ...
      <div className="relative">
        ...
        {text.length > 0 && (
          <button
            ...
            className="text-muted-foreground hover:bg-accent-soft hover:text-accent-ink absolute top-1/2 right-1 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-ring/50 outline-none"
          >
            <X className="h-4 w-4" />
          </button>
        )}
