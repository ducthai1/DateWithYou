      ...
      */}
      ...
      <section id="dang-ky" className="mx-auto max-w-3xl px-6 pb-24 text-center sm:pb-32">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/sign-up"
            className="btn-sheen flex h-14 w-full max-w-xs items-center justify-center rounded-full bg-[#c2693f] text-[17px] font-medium tracking-wide text-white shadow-[0_8px_20px_rgba(194,105,63,0.25)] transition-all hover:-translate-y-0.5 hover:bg-[#a8542f] active:translate-y-0 active:scale-[0.98]"
          >
            Tạo tài khoản
          </Link>
          <Link
      ...
      {/* Footer — the site map. One line with two links was the whole footer;
          a first-time visitor who scrolled to the end had nowhere to go. Same
          parchment palette; the columns say what exists (features, guides,
          account) and the bottom bar carries the one statement worth repeating. */}
